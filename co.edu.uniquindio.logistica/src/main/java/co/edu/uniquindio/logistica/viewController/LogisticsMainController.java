...
/**
 * Controlador principal de navegacion para la plataforma de logistica. Carga dinamicamente vistas
...
public class LogisticsMainController {
  ...
  /** Abre el panel principal de administracion. */
  @FXML
  ...
  /** Abre la pantalla de cotizacion de envios. */
  @FXML
  private void openQuote(ActionEvent e) throws IOException {
    loadIntoCenter("/logistics/user_quote.fxml");
  }

  /** Abre la pantalla de historial y pagos de envios del usuario. */
  @FXML
  ...
  /** Cierra la sesion actual y vuelve al mensaje inicial. */
  @FXML
  private void logout() {
